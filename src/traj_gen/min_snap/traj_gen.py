...
from src.traj_gen.min_snap.traj_utils import DesiredState, polyder, Hessian
...
class TrajGenerator:
    ...
    def get_cost(self,T):
        coeffs,cost = self.minimize_snap(T)
    ...
    def optimize(self):
        ...
        self.coeffs, self.cost = self.minimize_snap(T)


    def minimize_snap(self,T):
        unkns = 4*(self.len - 2)
